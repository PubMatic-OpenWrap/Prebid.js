import { logInfo, _each } from '../src/utils.js';
const GDPR_REGIONS = [
...
/* const COMPLIANCE_VIOLATIONS = {
  1: 'UserId Module violations.', // UserId module [module names], called when vendor consent was denied. Please check your CMP settings or reach out to your CMP vendor"
...
export function validateConsentData(dataObj) {
  ...
  logInfo('Compliance logger call - identifyViolations **** ' + dataObj['gdprA'] + ' *** ' + dataObj['loc']);
